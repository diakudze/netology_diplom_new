...
Процедура ПриЗаполненииПоставляемыхПрофилейГруппДоступа(ОписанияПрофилей, ПараметрыОбновления) Экспорт
	...
	ОписаниеПрофиля.Идентификатор = "f9a8d26c-79dc-4269-b33d-7bef263cf9f3";
	...
	ОписаниеПрофиля.Роли.Добавить("ВКМ_ДобавлениеИзменениеНСИ_ДобавленныеОбъекты"); 
	...
	ОписаниеПрофиля.Роли.Добавить("ВКМ_ИспользованиеИПросмотрОтчетаВыработкаСпециалистов"); 
	ОписаниеПрофиля.Роли.Добавить("ВКМ_РаботаСПодсистемойДобавленныеОбъекты");     
	ОписаниеПрофиля.Роли.Добавить("ВКМ_РаботаСПодсистемойОбслуживаниеКлиентов"); 
	...
	ОписаниеПрофиля.Идентификатор = "0e35dd41-54a2-481e-86fe-99d096c9720e";
	...
	ОписаниеПрофиля.Идентификатор = "78e9e90a-7eb6-4762-85fb-74da32941193";
	...
	ОписаниеПрофиля.Роли.Добавить("ВКМ_ДобавлениеИзменениеНСИ_ДобавленныеОбъекты");             
	ОписаниеПрофиля.Роли.Добавить("ВКМ_МассовоеСозданиеРеализацийТоваровИУслуг");  
	ОписаниеПрофиля.Роли.Добавить("ВКМ_ИспользованиеИПросмотрОтчетаАнализВыставленныхАктов"); 
	ОписаниеПрофиля.Роли.Добавить("ВКМ_РаботаСПодсистемойДобавленныеОбъекты");
	...
	ОписаниеПрофиля = УправлениеДоступом.НовоеОписаниеПрофиляГруппДоступа();
	ОписаниеПрофиля.Имя           = "ВКМ_КадровикРасчётчик";
	ОписаниеПрофиля.Идентификатор = "0cfe830b-e3a1-4720-aec7-cde926c5c7b9";
	ОписаниеПрофиля.Наименование  = НСтр("ru = 'Кадровики-расчётчик'", ОбщегоНазначения.КодОсновногоЯзыка());
	ОписаниеПрофиля.Роли.Добавить("ЗапускВебКлиента");
	ОписаниеПрофиля.Роли.Добавить("ЗапускТонкогоКлиента");
	ОписаниеПрофиля.Роли.Добавить("БазовыеПраваБСП");
	ОписаниеПрофиля.Роли.Добавить("ВыводНаПринтерФайлБуферОбмена");
	...
	ОписаниеПрофиля.Роли.Добавить("ВКМ_ДобавлениеИзменениеНСИ_ДобавленныеОбъекты"); 
	ОписаниеПрофиля.Роли.Добавить("ВКМ_НачислениеЗаработнойПлатыИПремий");  
	ОписаниеПрофиля.Роли.Добавить("ВКМ_ВыплатаЗаработнойПлатыИПремий"); 
	ОписаниеПрофиля.Роли.Добавить("ВКМ_ЗаполнениеГрафикаРаботы");   
	ОписаниеПрофиля.Роли.Добавить("ВКМ_ДобавлениеИзменениеДокументовГрафикОтпусков"); 
	ОписаниеПрофиля.Роли.Добавить("ВКМ_ДобавлениеИзменениеДокументовРеализацияТоваровИУслуг");
	ОписаниеПрофиля.Роли.Добавить("ВКМ_ИспользованиеИПросмотрОтчетаВыработкаСпециалистов");  
	ОписаниеПрофиля.Роли.Добавить("ВКМ_ИспользованиеИПросмотрЗарплатныхОтчетовИОтчетовПоОтпускам"); 
	ОписаниеПрофиля.Роли.Добавить("ВКМ_РаботаСПодсистемойДобавленныеОбъекты"); 
	ОписаниеПрофиля.Роли.Добавить("ВКМ_РаботаСПодсистемойРасчеты");
